...
for(const marker of [
  './gejast-badges.js?v818',
  './gejast-badge-progress.js?v818',
...
for(const marker of ['./gejast-badges.js?v818','./gejast-badge-progress.js?v818','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
