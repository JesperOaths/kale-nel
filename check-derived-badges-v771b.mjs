...
for(const marker of [
  './gejast-badges.js?v798',
  './gejast-badge-progress.js?v798',
...
for(const marker of ['./gejast-badges.js?v798','./gejast-badge-progress.js?v798','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
