...
for(const marker of [
  './gejast-badges.js?v813',
  './gejast-badge-progress.js?v813',
...
for(const marker of ['./gejast-badges.js?v813','./gejast-badge-progress.js?v813','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
