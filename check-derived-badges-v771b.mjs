...
for(const marker of [
  './gejast-badges.js?v791',
  './gejast-badge-progress.js?v791',
...
for(const marker of ['./gejast-badges.js?v791','./gejast-badge-progress.js?v791','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
