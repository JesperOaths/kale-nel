...
for(const marker of [
  './gejast-badges.js?v804',
  './gejast-badge-progress.js?v804',
...
for(const marker of ['./gejast-badges.js?v804','./gejast-badge-progress.js?v804','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
