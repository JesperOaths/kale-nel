...
for(const marker of [
  './gejast-badges.js?v788',
  './gejast-badge-progress.js?v788',
...
for(const marker of ['./gejast-badges.js?v788','./gejast-badge-progress.js?v788','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
