...
for(const marker of [
  './gejast-badges.js?v790',
  './gejast-badge-progress.js?v790',
...
for(const marker of ['./gejast-badges.js?v790','./gejast-badge-progress.js?v790','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
