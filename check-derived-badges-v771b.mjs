...
for(const marker of [
  './gejast-badges.js?v801',
  './gejast-badge-progress.js?v801',
...
for(const marker of ['./gejast-badges.js?v801','./gejast-badge-progress.js?v801','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
