...
for(const marker of [
  './gejast-badges.js?v786',
  './gejast-badge-progress.js?v786',
...
for(const marker of ['./gejast-badges.js?v786','./gejast-badge-progress.js?v786','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
