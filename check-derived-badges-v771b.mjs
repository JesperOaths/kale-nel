...
for(const marker of [
  './gejast-badges.js?v815',
  './gejast-badge-progress.js?v815',
...
for(const marker of ['./gejast-badges.js?v815','./gejast-badge-progress.js?v815','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
