...
for(const marker of [
  './gejast-badges.js?v795',
  './gejast-badge-progress.js?v795',
...
for(const marker of ['./gejast-badges.js?v795','./gejast-badge-progress.js?v795','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
