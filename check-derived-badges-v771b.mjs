...
for(const marker of [
  './gejast-badges.js?v783',
  './gejast-badge-progress.js?v783',
...
for(const marker of ['./gejast-badges.js?v783','./gejast-badge-progress.js?v783','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
