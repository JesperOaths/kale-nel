...
for(const marker of [
  './gejast-badges.js?v777',
  './gejast-badge-progress.js?v777',
...
for(const marker of ['./gejast-badges.js?v777','./gejast-badge-progress.js?v777','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
