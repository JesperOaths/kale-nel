...
for(const marker of [
  './gejast-badges.js?v810',
  './gejast-badge-progress.js?v810',
...
for(const marker of ['./gejast-badges.js?v810','./gejast-badge-progress.js?v810','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
