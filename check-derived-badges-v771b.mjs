...
for(const marker of [
  './gejast-badges.js?v796',
  './gejast-badge-progress.js?v796',
...
for(const marker of ['./gejast-badges.js?v796','./gejast-badge-progress.js?v796','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
