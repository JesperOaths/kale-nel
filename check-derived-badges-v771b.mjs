...
for(const marker of [
  './gejast-badges.js?v794',
  './gejast-badge-progress.js?v794',
...
for(const marker of ['./gejast-badges.js?v794','./gejast-badge-progress.js?v794','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
