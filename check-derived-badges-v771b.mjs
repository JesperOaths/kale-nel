...
for(const marker of [
  './gejast-badges.js?v799',
  './gejast-badge-progress.js?v799',
...
for(const marker of ['./gejast-badges.js?v799','./gejast-badge-progress.js?v799','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
