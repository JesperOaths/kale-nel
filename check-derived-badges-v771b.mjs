...
for(const marker of [
  './gejast-badges.js?v785',
  './gejast-badge-progress.js?v785',
...
for(const marker of ['./gejast-badges.js?v785','./gejast-badge-progress.js?v785','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
