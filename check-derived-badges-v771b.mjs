...
for(const marker of [
  './gejast-badges.js?v816',
  './gejast-badge-progress.js?v816',
...
for(const marker of ['./gejast-badges.js?v816','./gejast-badge-progress.js?v816','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
