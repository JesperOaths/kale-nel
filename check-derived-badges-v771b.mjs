...
for(const marker of [
  './gejast-badges.js?v817',
  './gejast-badge-progress.js?v817',
...
for(const marker of ['./gejast-badges.js?v817','./gejast-badge-progress.js?v817','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
