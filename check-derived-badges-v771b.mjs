...
for(const marker of [
  './gejast-badges.js?v797',
  './gejast-badge-progress.js?v797',
...
for(const marker of ['./gejast-badges.js?v797','./gejast-badge-progress.js?v797','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
