...
for(const marker of [
  './gejast-badges.js?v789',
  './gejast-badge-progress.js?v789',
...
for(const marker of ['./gejast-badges.js?v789','./gejast-badge-progress.js?v789','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
