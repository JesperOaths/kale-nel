...
for(const marker of [
  './gejast-badges.js?v805',
  './gejast-badge-progress.js?v805',
...
for(const marker of ['./gejast-badges.js?v805','./gejast-badge-progress.js?v805','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
