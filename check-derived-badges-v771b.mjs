...
for(const marker of [
  './gejast-badges.js?v775',
  './gejast-badge-progress.js?v775',
...
for(const marker of ['./gejast-badges.js?v775','./gejast-badge-progress.js?v775','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
