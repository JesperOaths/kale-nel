...
for(const marker of [
  './gejast-badges.js?v811',
  './gejast-badge-progress.js?v811',
...
for(const marker of ['./gejast-badges.js?v811','./gejast-badge-progress.js?v811','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
