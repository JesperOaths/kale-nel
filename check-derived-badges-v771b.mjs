...
for(const marker of [
  './gejast-badges.js?v802',
  './gejast-badge-progress.js?v802',
...
for(const marker of ['./gejast-badges.js?v802','./gejast-badge-progress.js?v802','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
