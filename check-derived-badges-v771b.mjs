...
for(const marker of [
  './gejast-badges.js?v806',
  './gejast-badge-progress.js?v806',
...
for(const marker of ['./gejast-badges.js?v806','./gejast-badge-progress.js?v806','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
