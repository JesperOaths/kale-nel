...
for(const marker of [
  './gejast-badges.js?v800',
  './gejast-badge-progress.js?v800',
...
for(const marker of ['./gejast-badges.js?v800','./gejast-badge-progress.js?v800','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
