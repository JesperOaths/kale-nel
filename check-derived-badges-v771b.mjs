...
for(const marker of [
  './gejast-badges.js?v814',
  './gejast-badge-progress.js?v814',
...
for(const marker of ['./gejast-badges.js?v814','./gejast-badge-progress.js?v814','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
