...
for(const marker of [
  './gejast-badges.js?v807',
  './gejast-badge-progress.js?v807',
...
for(const marker of ['./gejast-badges.js?v807','./gejast-badge-progress.js?v807','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
