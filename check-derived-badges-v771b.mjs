...
for(const marker of [
  './gejast-badges.js?v779',
  './gejast-badge-progress.js?v779',
...
for(const marker of ['./gejast-badges.js?v779','./gejast-badge-progress.js?v779','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
