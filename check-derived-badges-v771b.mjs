...
for(const marker of [
  './gejast-badges.js?v803',
  './gejast-badge-progress.js?v803',
...
for(const marker of ['./gejast-badges.js?v803','./gejast-badge-progress.js?v803','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
