...
for(const marker of [
  './gejast-badges.js?v780',
  './gejast-badge-progress.js?v780',
...
for(const marker of ['./gejast-badges.js?v780','./gejast-badge-progress.js?v780','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
