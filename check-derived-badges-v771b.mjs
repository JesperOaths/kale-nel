...
for(const marker of [
  './gejast-badges.js?v781',
  './gejast-badge-progress.js?v781',
...
for(const marker of ['./gejast-badges.js?v781','./gejast-badge-progress.js?v781','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
