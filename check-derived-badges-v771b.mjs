...
for(const marker of [
  './gejast-badges.js?v809',
  './gejast-badge-progress.js?v809',
...
for(const marker of ['./gejast-badges.js?v809','./gejast-badge-progress.js?v809','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
