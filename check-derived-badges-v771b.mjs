...
for(const marker of [
  './gejast-badges.js?v812',
  './gejast-badge-progress.js?v812',
...
for(const marker of ['./gejast-badges.js?v812','./gejast-badge-progress.js?v812','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
