...
for(const marker of [
  './gejast-badges.js?v778',
  './gejast-badge-progress.js?v778',
...
for(const marker of ['./gejast-badges.js?v778','./gejast-badge-progress.js?v778','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
