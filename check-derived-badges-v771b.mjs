...
for(const marker of [
  './gejast-badges.js?v787',
  './gejast-badge-progress.js?v787',
...
for(const marker of ['./gejast-badges.js?v787','./gejast-badge-progress.js?v787','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
