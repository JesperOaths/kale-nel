...
for(const marker of [
  './gejast-badges.js?v782',
  './gejast-badge-progress.js?v782',
...
for(const marker of ['./gejast-badges.js?v782','./gejast-badge-progress.js?v782','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
