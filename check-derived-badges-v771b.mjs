...
for(const marker of [
  './gejast-badges.js?v784',
  './gejast-badge-progress.js?v784',
...
for(const marker of ['./gejast-badges.js?v784','./gejast-badge-progress.js?v784','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
