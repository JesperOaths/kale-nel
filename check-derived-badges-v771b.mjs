...
for(const marker of [
  './gejast-badges.js?v776',
  './gejast-badge-progress.js?v776',
...
for(const marker of ['./gejast-badges.js?v776','./gejast-badge-progress.js?v776','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
