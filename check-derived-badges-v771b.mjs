...
for(const marker of [
  './gejast-badges.js?v771',
  './gejast-badge-progress.js?v771',
...
for(const marker of ['./gejast-badges.js?v771','./gejast-badge-progress.js?v771','badgeGalleryPanel']) if(!profiles.includes(marker)) failures.push(`profiles.html missing badge gallery marker: ${marker}`);
