(() => {
  ...
  function viewsFor(product, color){
    ...
    const artwork = all.find(view => /artwork|print file|design png/i.test(String(view?.label || '')))
  ...
  window.BRUIS_TOTE_HANDLE_COLOR_V839 = Object.freeze({
    release: 'v839',
