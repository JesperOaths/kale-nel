  ...
  async function submitCheckout(event){
    ...
    try {
      ...
      if(!response.ok || !result?.ok){
        ...
        throw new Error(/token unavailable|production connection/i.test(detail)
