(() => {
  ...
  const style=document.createElement('style');style.dataset.shopLightboxV832='true';style.textContent=`
    ...
    .shop-lightbox-v832-media img{display:block;width:auto!important;height:auto!important;max-width:80%!important;max-height:80%!important;object-fit:contain!important;object-position:center!important;background:transparent!important;transform:translate3d(0,0,0) scale(1);transform-origin:center;user-select:none;-webkit-user-drag:none;transition:transform .1s ease-out}
