...
drop function if exists public.create_player_activation_link_safe(text, text, text);
...
drop function if exists public.admin_decide_claim_request_safe(text, text, text, text);
...
drop function if exists public.admin_revoke_player_access_safe(text, text, text);
...
drop function if exists public.admin_requeue_expired_activation_safe(text, text);
...
drop function if exists public.admin_resend_expired_activation_safe(text, text, text);
