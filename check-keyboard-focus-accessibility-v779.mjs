...
console.log(`v779 keyboard/focus accessibility PASS at ${version}: public pages avoid forced tab order/non-native inline clicks/outline suppression, Drinks has an explicit focus-visible ring, and shared clickable cards retain Enter/Space activation.`);
