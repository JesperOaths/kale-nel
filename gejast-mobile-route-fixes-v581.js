(function(){
  ...
  function patchHome(){
    injectStyle('gejast-mobile-home-v581', `
  ...
  function patchPlayer(){
    injectStyle('gejast-mobile-player-v581', `
  ...
  function patchScore(){
    injectStyle('gejast-mobile-score-v581', `
      @media (max-width:760px){
  ...
  function patchLegacySheets(){
    injectStyle('gejast-mobile-legacy-sheets-v581', `
      @media (max-width:760px){
        body{padding:12px !important;}
  ...
  function patchIndex(){
    injectStyle('gejast-mobile-index-v581', `
      @media (max-width:760px){
  ...
  function patchScorer(){
    injectStyle('gejast-mobile-scorer-v581', `
      @media (max-width:760px){
  ...
  function patchLegacyForms(){
    injectStyle('gejast-mobile-forms-v581', `
      @media (max-width:760px){
