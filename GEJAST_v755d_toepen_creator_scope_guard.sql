-- GEJAST v755d: Toepen save-side creator/scope guard.
-- SQL-only forward fix after v755/v755b/v755c.
-- Requires the saving player to match the requested scope and be one of the participants.
