(function(){
  const CONFIG = {
    ...
    ADMIN_ACTIVE_PUSH_RPC: 'admin_queue_active_web_push',
    ADMIN_ACTIVE_PUSH_LIST_RPC: 'admin_get_active_web_push_presence',
    ACTIVE_PUSH_TOUCH_RPC: 'touch_active_web_push_presence',
  };
