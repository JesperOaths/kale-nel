...
function buildRequestUrl(returnTo, scope){
  ...
  const FAST_RUNTIME = window.GEJAST_FAST_RUNTIME || (function(){
    ...
    return { VERSION:'v721', DEFAULT_TIMEOUT_MS, timeoutPromise, race, fetchJson, idle, showPageNow };
  })();
  ...
  try {
    if (typeof document !== 'undefined' && !document.querySelector('script[src*="gejast-v721-repair.js"]')) {
      var v721s = document.createElement('script');
      v721s.src = './gejast-v721-repair.js?v721';
      v721s.async = false;
      document.head.appendChild(v721s);
    }
  } catch (_) {}
