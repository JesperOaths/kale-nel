...
### Gate coverage
Injected `gejast-home-gate.js?v653` into root pages that had config loaded but were missing the player gate, including the despimarkt/admin/live/ladder pages that were still missing it in the snapshot.
