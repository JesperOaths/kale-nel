...
function allowedIndependentWatermark(rel,found){return (rel==='admin_shop_orders.html'&&found==='858')||(rel==='admin_shop_connection.html'&&found==='828')||(rel==='admin_shop_analytics.html'&&found==='843')||(rel==='admin_shop_operations.html'&&found==='858');}
