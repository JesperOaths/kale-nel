...
function allowedIndependentWatermark(rel,found){return (rel==='admin_shop_orders.html'&&found==='826')||(rel==='admin_shop_connection.html'&&found==='828')||(rel==='admin_shop_analytics.html'&&found==='841');}
