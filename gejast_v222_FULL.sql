...
-- v222 rebuilt from the uploaded gejast_patch_v220_FULL.sql base.
-- Goals:
...
grant execute on function public.create_combined_drink_speed_attempt(text,text,numeric,numeric,numeric,numeric,numeric) to anon, authenticated;
