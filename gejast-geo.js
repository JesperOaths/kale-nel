(function(){
  ...
  function ensureCornerTools(){
    ...
    if (window.innerWidth <= 640){ existing.style.top='auto'; existing.style.right='12px'; existing.style.bottom='108px'; existing.style.flexDirection='column'; } else { existing.style.top='14px'; existing.style.right='14px'; existing.style.bottom='auto'; existing.style.flexDirection='row'; }
