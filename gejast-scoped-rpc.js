(function (global) {
  ...
  const SCOPE_REQUIRED_RPCS = new Set([
    ...
    'despimarkt_get_wallet_scoped',
    'despimarkt_get_caute_balance_scoped',
    'despimarkt_get_caute_ledger_scoped',
    'despimarkt_ensure_caute_account_scoped',
    'despimarkt_get_mint_options_scoped',
    'despimarkt_create_caute_mint_request_scoped',
    'despimarkt_get_nomination_rules_scoped',
    'despimarkt_create_drink_nomination_scoped',
    'despimarkt_get_debts_page_scoped',
    'despimarkt_submit_debt_clear_request_scoped',
    'despimarkt_get_wall_of_shame_scoped',
    'despimarkt_get_dry_dock_stats_scoped',
    'despimarkt_get_market_list_scoped',
    ...
    'get_caute_coin_top5_public_scoped',
