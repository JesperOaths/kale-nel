(function(){
  ...
  function patchHome(){
    injectStyle('gejast-mobile-home-v582', `
  ...
  function patchPlayer(){
    injectStyle('gejast-mobile-player-v582', `
  ...
  function patchScore(){
    injectStyle('gejast-mobile-score-v582', `
      @media (max-width:760px){
  ...
  function patchLegacySheets(){
    injectStyle('gejast-mobile-legacy-sheets-v582', `
      @media (max-width:760px){
        body{padding:12px !important;}
  ...
  function patchIndex(){
    injectStyle('gejast-mobile-index-v582', `
      @media (max-width:760px){
  ...
  function patchScorer(){
    injectStyle('gejast-mobile-scorer-v582', `
      @media (max-width:760px){
  ...
  function patchLegacyForms(){
    injectStyle('gejast-mobile-forms-v582', `
      @media (max-width:760px){
