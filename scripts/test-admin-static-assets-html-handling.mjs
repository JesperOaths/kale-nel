...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v787'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v787/);
assert.match(adminHtml, /admin-session-sync\.js\?v787/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v787'/);
