...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v814'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v814/);
assert.match(adminHtml, /admin-session-sync\.js\?v814/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v814'/);
