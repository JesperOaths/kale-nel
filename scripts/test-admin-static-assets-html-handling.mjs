...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v803'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v803/);
assert.match(adminHtml, /admin-session-sync\.js\?v803/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v803'/);
