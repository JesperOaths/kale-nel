...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v790'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v790/);
assert.match(adminHtml, /admin-session-sync\.js\?v790/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v790'/);
