...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v772'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v772/);
assert.match(adminHtml, /admin-session-sync\.js\?v772/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v772'/);
