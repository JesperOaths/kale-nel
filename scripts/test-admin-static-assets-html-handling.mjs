...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v781'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v781/);
assert.match(adminHtml, /admin-session-sync\.js\?v781/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v781'/);
