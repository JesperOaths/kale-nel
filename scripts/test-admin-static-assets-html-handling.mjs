...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v791'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v791/);
assert.match(adminHtml, /admin-session-sync\.js\?v791/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v791'/);
