...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v794'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v794/);
assert.match(adminHtml, /admin-session-sync\.js\?v794/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v794'/);
