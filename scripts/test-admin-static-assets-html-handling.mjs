...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v774'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v774/);
assert.match(adminHtml, /admin-session-sync\.js\?v774/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v774'/);
