...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v792'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v792/);
assert.match(adminHtml, /admin-session-sync\.js\?v792/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v792'/);
