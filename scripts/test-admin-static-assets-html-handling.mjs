...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v777'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v777/);
assert.match(adminHtml, /admin-session-sync\.js\?v777/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v777'/);
