...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v766'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v766/);
assert.match(adminHtml, /admin-session-sync\.js\?v766/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v766'/);
