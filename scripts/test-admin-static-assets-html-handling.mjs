...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v810'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v810/);
assert.match(adminHtml, /admin-session-sync\.js\?v810/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v810'/);
