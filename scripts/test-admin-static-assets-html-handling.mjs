...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v812'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v812/);
assert.match(adminHtml, /admin-session-sync\.js\?v812/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v812'/);
