...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v797'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v797/);
assert.match(adminHtml, /admin-session-sync\.js\?v797/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v797'/);
