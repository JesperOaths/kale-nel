...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v815'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v815/);
assert.match(adminHtml, /admin-session-sync\.js\?v815/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v815'/);
