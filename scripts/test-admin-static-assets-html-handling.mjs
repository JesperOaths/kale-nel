...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v789'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v789/);
assert.match(adminHtml, /admin-session-sync\.js\?v789/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v789'/);
