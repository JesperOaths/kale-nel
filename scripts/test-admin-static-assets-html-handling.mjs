...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v764'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v764/);
assert.match(adminHtml, /admin-session-sync\.js\?v764/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v764'/);
