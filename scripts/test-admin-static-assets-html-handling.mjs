...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v807'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v807/);
assert.match(adminHtml, /admin-session-sync\.js\?v807/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v807'/);
