...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v808'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v808/);
assert.match(adminHtml, /admin-session-sync\.js\?v808/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v808'/);
