...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v767'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v767/);
assert.match(adminHtml, /admin-session-sync\.js\?v767/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v767'/);
