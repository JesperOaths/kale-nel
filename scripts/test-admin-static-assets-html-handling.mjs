...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v784'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v784/);
assert.match(adminHtml, /admin-session-sync\.js\?v784/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v784'/);
