...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v799'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v799/);
assert.match(adminHtml, /admin-session-sync\.js\?v799/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v799'/);
