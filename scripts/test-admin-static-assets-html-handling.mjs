...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v782'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v782/);
assert.match(adminHtml, /admin-session-sync\.js\?v782/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v782'/);
