...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v813'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v813/);
assert.match(adminHtml, /admin-session-sync\.js\?v813/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v813'/);
