...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v773'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v773/);
assert.match(adminHtml, /admin-session-sync\.js\?v773/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v773'/);
