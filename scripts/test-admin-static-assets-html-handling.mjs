...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v769'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v769/);
assert.match(adminHtml, /admin-session-sync\.js\?v769/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v769'/);
