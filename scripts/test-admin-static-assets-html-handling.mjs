...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v817'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v817/);
assert.match(adminHtml, /admin-session-sync\.js\?v817/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v817'/);
