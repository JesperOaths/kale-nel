...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v801'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v801/);
assert.match(adminHtml, /admin-session-sync\.js\?v801/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v801'/);
