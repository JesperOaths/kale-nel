...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v783'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v783/);
assert.match(adminHtml, /admin-session-sync\.js\?v783/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v783'/);
