...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v798'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v798/);
assert.match(adminHtml, /admin-session-sync\.js\?v798/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v798'/);
