...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v809'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v809/);
assert.match(adminHtml, /admin-session-sync\.js\?v809/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v809'/);
