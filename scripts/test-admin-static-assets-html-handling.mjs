...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v816'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v816/);
assert.match(adminHtml, /admin-session-sync\.js\?v816/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v816'/);
