...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v785'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v785/);
assert.match(adminHtml, /admin-session-sync\.js\?v785/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v785'/);
