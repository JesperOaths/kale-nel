...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v811'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v811/);
assert.match(adminHtml, /admin-session-sync\.js\?v811/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v811'/);
