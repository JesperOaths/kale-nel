...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v818'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v818/);
assert.match(adminHtml, /admin-session-sync\.js\?v818/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v818'/);
