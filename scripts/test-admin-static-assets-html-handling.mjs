...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v786'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v786/);
assert.match(adminHtml, /admin-session-sync\.js\?v786/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v786'/);
