...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v806'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v806/);
assert.match(adminHtml, /admin-session-sync\.js\?v806/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v806'/);
