...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v779'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v779/);
assert.match(adminHtml, /admin-session-sync\.js\?v779/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v779'/);
