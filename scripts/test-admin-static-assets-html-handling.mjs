...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v800'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v800/);
assert.match(adminHtml, /admin-session-sync\.js\?v800/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v800'/);
