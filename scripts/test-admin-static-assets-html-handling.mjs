...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v776'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v776/);
assert.match(adminHtml, /admin-session-sync\.js\?v776/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v776'/);
