...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v778'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v778/);
assert.match(adminHtml, /admin-session-sync\.js\?v778/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v778'/);
