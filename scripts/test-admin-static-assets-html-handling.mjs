...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v775'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v775/);
assert.match(adminHtml, /admin-session-sync\.js\?v775/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v775'/);
