...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v805'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v805/);
assert.match(adminHtml, /admin-session-sync\.js\?v805/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v805'/);
