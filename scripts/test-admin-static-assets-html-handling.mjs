...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v780'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v780/);
assert.match(adminHtml, /admin-session-sync\.js\?v780/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v780'/);
