...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v804'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v804/);
assert.match(adminHtml, /admin-session-sync\.js\?v804/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v804'/);
