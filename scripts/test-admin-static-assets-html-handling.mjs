...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v802'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v802/);
assert.match(adminHtml, /admin-session-sync\.js\?v802/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v802'/);
