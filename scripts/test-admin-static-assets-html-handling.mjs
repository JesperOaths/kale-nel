...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v765'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v765/);
assert.match(adminHtml, /admin-session-sync\.js\?v765/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v765'/);
