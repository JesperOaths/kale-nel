...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v793'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v793/);
assert.match(adminHtml, /admin-session-sync\.js\?v793/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v793'/);
