...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v768'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v768/);
assert.match(adminHtml, /admin-session-sync\.js\?v768/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v768'/);
