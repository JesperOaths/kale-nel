...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v762'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v762/);
assert.match(adminHtml, /admin-session-sync\.js\?v762/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v762'/);
