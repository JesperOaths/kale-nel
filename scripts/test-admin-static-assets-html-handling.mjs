...
assert.match(adminHtml, /GEJAST_PAGE_VERSION='v788'/);
assert.match(adminHtml, /gejast-home-gate\.js\?v788/);
assert.match(adminHtml, /admin-session-sync\.js\?v788/);
...
assert.match(postFixDirect.finalBodySnippet, /GEJAST_PAGE_VERSION='v788'/);
