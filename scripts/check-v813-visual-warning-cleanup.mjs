...
// The browser session parser accepts exactly 48 hexadecimal characters. Certification
// fixtures must use the same contract; prefixed synthetic tokens can pass SQL/RPC checks
// while being rejected by gejast-config.js and produce false login redirects.
