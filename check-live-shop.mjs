...
assert.match(lightbox, /max-width:80%!important/, 'Fit must leave horizontal breathing room');
assert.match(lightbox, /max-height:80%!important/, 'Fit must leave vertical breathing room');
