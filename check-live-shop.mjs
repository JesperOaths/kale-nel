...
const SHOP_V869_VERSION = '20260926-storefront-v871-r2';
const DIRECT_V869_VERSION = '20260926-storefront-v871-r3';
const TRANSPARENCY_V869_VERSION = '20260926-storefront-v871-r3';
const STYLES_V869_VERSION = '20260926-storefront-v871-r5';
...
assert.match(html, /version-watermark[^>]*>v871</, 'Live shop must expose v868 watermark');
assert.match(html, /direct-commerce-v832\.js\?v=20260926-storefront-v871-r3/, 'Live shop must retain the direct commerce bridge');
assert.match(html, /store\.js\?v=20260926-storefront-v871-r2/, 'Live shop must load the current default-on animal-filter storefront runtime');
assert.match(html, /styles\.css\?v=20260926-storefront-v871-r5/, 'Live shop must load the staggered incomplete-row layout stylesheet');
...
assert.match(html, /storefront-polish-v832\.css\?v=20260926-storefront-v871-r2/, 'Live shop must load transparent media CSS');
...
assert.match(html, /gallery-fixes-v832\.js\?v=20260926-storefront-v871-r2/, 'Live shop must load exact carousel repair');
assert.match(html, /mockup-transparency-v832\.js\?v=20260926-storefront-v871-r3/, 'Live shop must load safe background transparency processor');
