-- GEJAST v755m rollback: restore the pre-v755m/v742 profile RPC definitions.
-- Use only if v755m has been applied and must be reverted. This intentionally
-- restores the previous production-compatible behavior, including the known
-- ambiguous-session-token risk documented in LIVE_WRITE_MATRIX_RESULTS_2026-08-03.md.
