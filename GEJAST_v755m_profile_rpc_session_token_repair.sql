-- GEJAST v755m: profile RPC session-token ambiguity/security repair (PREPARED ONLY).
-- Do not apply to production until the companion review/regression proof is accepted.
--
...
--   * resolve a real player before any profile-settings write
