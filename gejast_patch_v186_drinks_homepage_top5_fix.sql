-- Gejast v186
-- Fixes homepage drinks Top 5 RPC without assuming players.name or players.username exists.
-- Uses drink_events.player_name first, then players.display_name, otherwise 'Onbekend'.
